...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-label.switching-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7443&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-label.switching-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-label.switching` can be installed with:

```
conda install r-label.switching
```

It is possible to list all of the versions of `r-label.switching` available on your platform with:
